...
- `engine_scripts/onReady.js` forces lazy images eager, scrolls the full page,
...
- `crop.js` extracts a horizontal band from a tall screenshot for inspection:
  `node tests/backstop/crop.js <image> <y0> <y1> <out.png>`
